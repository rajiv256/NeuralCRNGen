...
rn_dual_node_relu_bwd = @reaction_network rn_dual_node_relu_bwd begin
    ...
    1.0, A0p + P00p + X0m --> A0p + A0p + P00p + X0m
    1.0, A0m + P00m + X0m --> A0p + A0m + P00m + X0m
    1.0, A0p + P00m + X0p --> A0p + A0p + P00m + X0p
    1.0, A0m + P00p + X0p --> A0p + A0m + P00p + X0p
    1.0, A0p + P00p + X0p --> A0m + A0p + P00p + X0p
    1.0, A0m + P00m + X0p --> A0m + A0m + P00m + X0p
    1.0, A0p + P00m + X0m --> A0m + A0p + P00m + X0m
    1.0, A0m + P00p + X0m --> A0m + A0m + P00p + X0m
    1.0, A0p + P01p + X1m --> A0p + A0p + P01p + X1m
    1.0, A0m + P01m + X1m --> A0p + A0m + P01m + X1m
    1.0, A0p + P01m + X1p --> A0p + A0p + P01m + X1p
    1.0, A0m + P01p + X1p --> A0p + A0m + P01p + X1p
    1.0, A0p + P01p + X1p --> A0m + A0p + P01p + X1p
    1.0, A0m + P01m + X1p --> A0m + A0m + P01m + X1p
    1.0, A0p + P01m + X1m --> A0m + A0p + P01m + X1m
    1.0, A0m + P01p + X1m --> A0m + A0m + P01p + X1m
    1.0, A0p + P02p + X2m --> A0p + A0p + P02p + X2m
    1.0, A0m + P02m + X2m --> A0p + A0m + P02m + X2m
    1.0, A0p + P02m + X2p --> A0p + A0p + P02m + X2p
    1.0, A0m + P02p + X2p --> A0p + A0m + P02p + X2p
    1.0, A0p + P02p + X2p --> A0m + A0p + P02p + X2p
    1.0, A0m + P02m + X2p --> A0m + A0m + P02m + X2p
    1.0, A0p + P02m + X2m --> A0m + A0p + P02m + X2m
    1.0, A0m + P02p + X2m --> A0m + A0m + P02p + X2m
    1.0, A0p + P03p + X3m --> A0p + A0p + P03p + X3m
    1.0, A0m + P03m + X3m --> A0p + A0m + P03m + X3m
    1.0, A0p + P03m + X3p --> A0p + A0p + P03m + X3p
    1.0, A0m + P03p + X3p --> A0p + A0m + P03p + X3p
    1.0, A0p + P03p + X3p --> A0m + A0p + P03p + X3p
    1.0, A0m + P03m + X3p --> A0m + A0m + P03m + X3p
    1.0, A0p + P03m + X3m --> A0m + A0p + P03m + X3m
    1.0, A0m + P03p + X3m --> A0m + A0m + P03p + X3m
    1.0, A0p + P04p + X4m --> A0p + A0p + P04p + X4m
    1.0, A0m + P04m + X4m --> A0p + A0m + P04m + X4m
    1.0, A0p + P04m + X4p --> A0p + A0p + P04m + X4p
    1.0, A0m + P04p + X4p --> A0p + A0m + P04p + X4p
    1.0, A0p + P04p + X4p --> A0m + A0p + P04p + X4p
    1.0, A0m + P04m + X4p --> A0m + A0m + P04m + X4p
    1.0, A0p + P04m + X4m --> A0m + A0p + P04m + X4m
    1.0, A0m + P04p + X4m --> A0m + A0m + P04p + X4m
    1.0, A1p + P10p + X0m --> A1p + A1p + P10p + X0m
    1.0, A1m + P10m + X0m --> A1p + A1m + P10m + X0m
    1.0, A1p + P10m + X0p --> A1p + A1p + P10m + X0p
    1.0, A1m + P10p + X0p --> A1p + A1m + P10p + X0p
    1.0, A1p + P10p + X0p --> A1m + A1p + P10p + X0p
    1.0, A1m + P10m + X0p --> A1m + A1m + P10m + X0p
    1.0, A1p + P10m + X0m --> A1m + A1p + P10m + X0m
    1.0, A1m + P10p + X0m --> A1m + A1m + P10p + X0m
    ...
    1.0, A2p + P20p + X0m --> A2p + A2p + P20p + X0m
    1.0, A2m + P20m + X0m --> A2p + A2m + P20m + X0m
    1.0, A2p + P20m + X0p --> A2p + A2p + P20m + X0p
    1.0, A2m + P20p + X0p --> A2p + A2m + P20p + X0p
    1.0, A2p + P20p + X0p --> A2m + A2p + P20p + X0p
    1.0, A2m + P20m + X0p --> A2m + A2m + P20m + X0p
    1.0, A2p + P20m + X0m --> A2m + A2p + P20m + X0m
    1.0, A2m + P20p + X0m --> A2m + A2m + P20p + X0m
    ...
    1.0, A3p + P30p + X0m --> A3p + A3p + P30p + X0m
    1.0, A3m + P30m + X0m --> A3p + A3m + P30m + X0m
    1.0, A3p + P30m + X0p --> A3p + A3p + P30m + X0p
    1.0, A3m + P30p + X0p --> A3p + A3m + P30p + X0p
    1.0, A3p + P30p + X0p --> A3m + A3p + P30p + X0p
    1.0, A3m + P30m + X0p --> A3m + A3m + P30m + X0p
    1.0, A3p + P30m + X0m --> A3m + A3p + P30m + X0m
    1.0, A3m + P30p + X0m --> A3m + A3m + P30p + X0m
    ...
    1.0, A4p + P40p + X0m --> A4p + A4p + P40p + X0m
    1.0, A4m + P40m + X0m --> A4p + A4m + P40m + X0m
    1.0, A4p + P40m + X0p --> A4p + A4p + P40m + X0p
    1.0, A4m + P40p + X0p --> A4p + A4m + P40p + X0p
    1.0, A4p + P40p + X0p --> A4m + A4p + P40p + X0p
    1.0, A4m + P40m + X0p --> A4m + A4m + P40m + X0p
    1.0, A4p + P40m + X0m --> A4m + A4p + P40m + X0m
    1.0, A4m + P40p + X0m --> A4m + A4m + P40p + X0m
